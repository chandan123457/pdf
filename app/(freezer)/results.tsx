...
export default function FreezerResultsTab() {
  ...
  const handleSharePDF = async () => {
    const pdfData: PDFData = {
      ...
      finalResults: [
        { label: 'Total Load (with 20% Safety)', value: (results.capacityTR * 3.517).toFixed(1), unit: 'kW' },
        { label: 'Refrigeration Capacity (with 20% Safety)', value: results.capacityTR.toFixed(1), unit: 'TR' },
        { label: 'Base Load (without safety)', value: results.loadInKw.toFixed(1), unit: 'kW' },
        { label: 'Base Refrigeration Capacity', value: results.totalLoadTR.toFixed(1), unit: 'TR' },
      ],
      inputs: [
        {
      ...
      sections: [
        {
          ...
          items: [
            ...
            { label: 'Total Transmission Load', value: results.totalTransmissionLoad.toFixed(1), unit: 'kW' },
          ]
        },
        {
          ...
          items: [
            ...
            { label: 'Latent Heat Load (Freezing)', value: results.latentHeatLoad.toFixed(1), unit: 'kW' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Occupancy Load', value: results.occupancyLoad.toFixed(1), unit: 'kW' },
            { label: 'Total Miscellaneous Load', value: results.totalMiscLoad.toFixed(1), unit: 'kW' },
          ]
        },
        {
          title: 'Heat Distribution',
          items: [
            { label: 'Sensible Heat', value: results.sensibleHeat.toFixed(1), unit: 'kW' },
            { label: 'Latent Heat', value: results.latentHeat.toFixed(1), unit: 'kW' },
