...
export default function ColdRoomResultsTab() {
  ...
  const handleSharePDF = async () => {
    const pdfData: PDFData = {
      ...
      finalResults: [
        { label: 'Load in kW', value: results.totalLoadKw?.toFixed(1) || '0.0', unit: 'kW' },
        { label: 'Refrigeration Capacity', value: results.refrigerationCapacityTR?.toFixed(1) || '0.0', unit: 'TR' },
        { label: 'Capacity with 20% Safety', value: results.capacityIncludingSafety?.toFixed(1) || '0.0', unit: 'TR' },
        { label: 'Load in BTU/hr', value: ((results.totalLoadKw || 0) * 3412).toFixed(1), unit: 'BTU/hr' },
      ],
      inputs: [
        {
